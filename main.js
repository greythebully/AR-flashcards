...
document.addEventListener('DOMContentLoaded', () => {
	const start = async() => {
		...
		airplaneAction.play();
		//calling aiplaneClip and we are loading the audio from our hard disk
		...
		//set the buffer audio to stream
		...
		//make airplane audio play only when the target of the airplane image is detected
